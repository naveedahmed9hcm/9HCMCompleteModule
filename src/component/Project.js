    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input1">Project Name</label>
...
<div className="">
    <div className="row">
        ...
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input2">EmployeeId FK</label>
...
<div className="">
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input1">DesignationId FK</label>
        ...
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input2">Budget</label>
...
<div className="">
    <div className="row">
        ...
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input2">Project Status</label>
