...
const EducaionUrl = "https://localhost:7035/api/EducationInformation/CreateEducationInformation";
...
const [study, setStudy]  = useState({
  ...
  function handle(e) {
    ...
    newStudy[e.target.id] = e.target.value
    setStudy(newStudy)
  ...
  function saveStudy(e) { 
    e.preventDefault();
    axios.post(EducaionUrl,
       {
        degrees: study.degrees,
        major: study.major,
        schoolinstitution: study.schoolinstitution,
        graduationyear: study.graduationyear,
        gpa: study.gpa,
  ...
  // Perform record Integration

  const PRUrl = "https://localhost:7035/api/PerformanceInformation/CreatePerformanceInformation";
      ...
      axios.post(EducaionUrl,
         {
          ...
          addcomments: record.addcomments,
          goalsset: record.goalsset,
          projectoutcomes: record.projectoutcomes,
          developmentplans: record.developmentplans,
      }
      )
      .then(res => console.log(res))
      .catch(err => console.error(err))
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"  onChange={(e) => handle(e)}value={study.degrees} placeholder='Degree' id='degrees' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"  onChange={(e) => handle(e)}value={study.major} placeholder='Major' id='major' required />
            </div>
        </div>
    </div>
</div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"  onChange={(e) => handle(e)}value={study.schoolinstitution} placeholder='School Institution' id='schoolinstitution' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="date" className="form-control"  onChange={(e) => handle(e)}value={study.graduationyear} placeholder='Graduation Year' id='graduationyear' required />
            </div>
        </div>
    </div>
</div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="number" className="form-control"  onChange={(e) => handle(e)}value={study.gpa} placeholder='GPA' id='gpa' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"  onChange={(e) => handle(e)}value={study.transcripts} placeholder='Transcripts' id='transcripts' required />
            </div>
        </div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="date" className="form-control" onChange={(e) => handlee(e)}value={record.evaluationdate} placeholder=' Evaluation Date' id='evaluationdate' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control"onChange={(e) => handlee(e)}value={record.supervisor} placeholder=' Supervisor' id='supervisor' required />
            </div>
        </div>
    </div>
</div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={(e) => handlee(e)}value={record.performancerating} placeholder=' Performance Rating' id='performancerating' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={(e) => handlee(e)}value={record.goalsset} placeholder=' Goals Set' id='goalsset' required />
            </div>
        </div>
    </div>
</div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={(e) => handlee(e)}value={record.addcomments} placeholder='Add Comments' id='addcomments' required />
            </div>
        </div>
        ...
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={(e) => handlee(e)}value={record.developmentplans} placeholder='Development Plans' id='developmentplans' required />
            </div>
        </div>
    </div>
</div>
    ...
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                ...
                <input type="text" className="form-control" onChange={(e) => handlee(e)}value={record.projectoutcomes} placeholder=' projectoutcomes' id='projectoutcomes' required />
            </div>
        </div>
    </div>
</div>
