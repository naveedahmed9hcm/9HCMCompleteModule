...
items={[
  ...
  >
      ...
      <ul>
<li>
 <Link to="/Board" > <i className="fa fa-question-circle-o" aria-hidden="true"></i>Board</Link> 
</li>
<li>
...
<div className="">
    <div className="row">
        ...
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input2"> Sub OrganizationId FK</label>
...
<div className="">
    <div className="row">
        ...
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input2">Department Name</label>
...
<div className="">
    <div className="row">
        <div className="col-md-6">
            <div className="form-group">
                <label htmlFor="input1">Phone No</label>
